...
/*   Updated: 2025/11/11 18:53:32 by moodeh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	exit_game(t_game *make_game)
{
	...
	mlx_destroy_image(make_game->mlx_ptr, make_game->collectible_texture);
	mlx_destroy_image(make_game->mlx_ptr, make_game->exit_texture);
	mlx_destroy_image(make_game->mlx_ptr, make_game->player_texture);
